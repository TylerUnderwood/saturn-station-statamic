...
/***/ "./resources/js/classes/appear.js":
/*!****************************************!*\
  !*** ./resources/js/classes/appear.js ***!
  \****************************************/
/***/ (() => {
...
var Appear = /*#__PURE__*/function () {
  ...
  _createClass(Appear, [{
    ...
    key: "setDelayedElements",
    value: function setDelayedElements() {
      this.delayedAppearElems.forEach(function (element) {
        var time = element.getAttribute('appear-delay');
        element.style.transitionDelay = time + 'ms';
      });
      return;
    }
  }, {
    key: "delayGroupedElements",
    value: function delayGroupedElements() {
      var _this = this;

      var groupNameList = []; // get all group names and add them to the list

      this.groupedAppearElems.forEach(function (element) {
        var groupName = element.getAttribute('appear-group'); // if the group name isn't already added, add it
      ...
      groupNameList.forEach(function (groupName) {
        var elementsGroup = document.querySelectorAll("[appear-group=\"".concat(groupName, "\"]"));
        elementsGroup.forEach(function (element, index) {
          element.style.transitionDelay = _this.groupInterval * index + 'ms';
        });
      });
      return;
    }
  }, {
    key: "checkForWithinFirePosition",
    value: function checkForWithinFirePosition(element) {
      var elemPosition = element.offsetTop;
      var firePosition = this.viewport.top - this.viewport.offset;
      var elemIsInView = elemPosition < this.viewport.bottom - this.viewport.offset;
      var elemIsInFirePosition = elemPosition >= firePosition || elemPosition < firePosition;
      return elemIsInView && elemIsInFirePosition;
    }
  }, {
    key: "runAnimation",
    value: function runAnimation(element) {
    ...
    value: function init() {
      ...
      window.addEventListener('scroll', function () {
        _this3.listenForAnimationTrigger();
      });
...
/***/ "./resources/js/classes/smooth-scroll.js":
/*!***********************************************!*\
  !*** ./resources/js/classes/smooth-scroll.js ***!
  \***********************************************/
/***/ (() => {
...
var SmoothScroll = /*#__PURE__*/function () {
  ...
  _createClass(SmoothScroll, [{
    ...
    key: "addScrollToEvent",
    value: function addScrollToEvent(buttons) {
...
/***/ "./resources/js/functions/theme-selector.js":
/*!**************************************************!*\
  !*** ./resources/js/functions/theme-selector.js ***!
  \**************************************************/
/***/ (() => {
...
new vue__WEBPACK_IMPORTED_MODULE_8__({
  el: '#site',
  components: {}
});
...
/******/ 	__webpack_require__.O(undefined, ["css/site","css/tailwind"], () => (__webpack_require__("./resources/js/site.js")))
/******/ 	__webpack_require__.O(undefined, ["css/site","css/tailwind"], () => (__webpack_require__("./resources/sass/site.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/site","css/tailwind"], () => (__webpack_require__("./resources/css/tailwind.css")))
